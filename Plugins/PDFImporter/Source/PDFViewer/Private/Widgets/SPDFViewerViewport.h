...
public:
	...
	SLATE_BEGIN_ARGS(SPDFViewerViewport) { }
	SLATE_END_ARGS()
...
public:
	 ...
	 */
	void Construct( const FArguments& InArgs, const TSharedRef<IPDFViewerToolkit>& InToolkit );
...
private:
	...
	TWeakPtr<IPDFViewerToolkit> ToolkitPtr;
	
	// Level viewport client.
	TSharedPtr<class FPDFViewerViewportClient> ViewportClient;
